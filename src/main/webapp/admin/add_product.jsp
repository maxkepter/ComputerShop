      ...
      <form action="AddProduct" method="post" class="product-form">
        ...
        <div class="form-group">
          ...
          <input
            ...
            pattern="^[1-9][0-9]*$"
            title="Please enter a valid positive integer"
            required
          />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input
            ...
            pattern="^\d+(\.\d{1,2})?$"
            title="Enter a valid price (e.g., 100 or 100.99)"
            required
          />
        </div>
        <div class="form-group">
          ...
          <a href="BrandManagement">Add new brand</a>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div id="specificationFields">
            <div id="specificationInfo">
              ...
              <label>Specification Product</label>
              <input type="text" name="specProduct" />
              <label>Specification Value</label>
              <input type="text" name="specValue" pattern="^\d+(\.\d{1,2})?$" />
            </div>
          </div>
        ...
        <div class="form-group">
          ...
          <div id="imageFields">
			<input
			  ...
			  required
			/>
          <button type="button" onclick="addField('image')">More images</button>
